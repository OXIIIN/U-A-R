...
var HEADER_GROUPS = [
  ...
  },
  {
    ...
    children: [
      { key: 'Q1', label: 'Q1', children: [{ key: 'q1_score', label: '绩效分' }, { key: 'q1_att', label: '考勤分' }] },
      { key: 'Q2', label: 'Q2', children: [{ key: 'q2_score', label: '绩效分' }, { key: 'q2_att', label: '考勤分' }] },
      { key: 'Q3', label: 'Q3', children: [{ key: 'q3_score', label: '绩效分' }, { key: 'q3_att', label: '考勤分' }] },
      { key: 'Q4', label: 'Q4', children: [{ key: 'q4_score', label: '绩效分' }, { key: 'q4_att', label: '考勤分' }] }
    ]
  },
  {
...
// ---- 默认活动信息列 ----
var DEFAULT_GROUPS = ['quarterly', 'passRate']
